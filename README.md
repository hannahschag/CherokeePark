...
<head>
  <meta charset="utf-8" />
  <title>Cherokee Park in Louisville, Kentucky</title>
...
<body>
  <section>
    ...
    <iframe title="Cherokee Park" width="100%" height="576"
      src="https://ion.cesium.com/stories/viewer/?id=78c284f2-fa6f-439e-8b67-50f147302574"
    ...
    <p class="caption">Slideshow demonstrating interesting features in Cherokee Park</p>
    <div class="title">
      <h1>Visualizing Cherokee Park</h1>
      <h2>The heart of the Highlands!</h2>
    </div>
    <div class="container">
      <div class="left-column">
        <p>
          Cherokee Park was designed by Frederick Law Olmstead, and is a part of
          the Louisville Olmstead Parks Conservancy. It is over 100 years old, being established in 1891.
        </p>

        <p>
          The goal of this project is to become familiar with Cherokee Park.
        </p>
        ...
        <p>
          Page and visualizations created by Hannah Schagene for GEO 409, Department of
      ...
      <div class="right-column">
        <img src="CherokeePark.jpg" alt="Cherokee Park Shaded Relief" width="100%" />
        <p class="caption">Topographical Features of the Park</p>
        <iframe width="100%" height="600" src="https://www.youtube.com/embed/l2rvCwlm-PA" title="Cherokee Park LIDAR Video Visualization" 
